...
final class SMPP
{
    ...
    // Type Of Number (TON) SMPP v3.4 - 5.2.5 page 117
    ...
    // Numeric Plan Indicator (NIP) SMPP v3.4 - 5.2.6 page 118
    ...
    static $messages = [
        ...
        SMPP::ESME_RINVSUBREP => 'Invalid “submit with replace” request',
        ...
        SMPP::ESME_RTHROTTLED => 'Throttling error (ESME exceeded limits)',
    ...
    /**
     * Obtiene el status del SMSC
     * @param  int $statuscode  Código devuelto por el SMSC
     * @return string           Descripción del error
     */
    public static function getSmppStatusMessage(int $statuscode): string
    {
        return self::$messages[$statuscode] ?? 'Unknown statuscode: ' . dechex($statuscode);
    }
}
